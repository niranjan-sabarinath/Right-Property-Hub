...
import {
    ...
    useTransform,
    AnimatePresence,
    AnimatePresence as AnimatePresenceMotion,
} from "framer-motion";
...
const HomePage = () => {
    ...
    const indianProperties = allProperties.filter(
        (property) =>
            ...
            (property.location &&
                property.location.toLowerCase().includes("india")) ||
    ...
    const parsePrice = (price: string | number): number => {
        ...
        const priceStr = price.toString().split("–")[0].trim();
    ...
    useEffect(() => {
        ...
        if (filters.minPrice || filters.maxPrice) {
            const minPrice = filters.minPrice
                ? parseFloat(filters.minPrice) * 10000000
                : 0; // Convert CR to base units
            const maxPrice = filters.maxPrice
                ? parseFloat(filters.maxPrice) * 10000000
                : Number.MAX_SAFE_INTEGER; // Convert CR to base units
        ...
        } else if (filters.sortBy === "none" && filters.status === "For Rent") {
            // Default sorting for rentals: sort by price low to high
            filtered.sort((a, b) => parsePrice(a.price) - parsePrice(b.price));
        }

        setFilteredProperties(filtered);
        setCurrentPage(1); // Reset to first page when filters change
    }, [filters, indianProperties]);
    ...
    const whatsappNumber = "971505755424"; // Replace with actual Indian phone number
                ...
                <div className="w-full md:w-3/5 min-h-screen bg-gradient-to-br from-primary/5 to-background px-4 sm:px-8 md:pl-16 lg:pl-24 xl:pl-32 2xl:pl-48 pr-4 sm:pr-8 flex flex-col justify-center items-start pt-24 sm:pt-28 md:pt-32 lg:pt-40 relative overflow-hidden">
                    ...
                    >
                        ...
                        >
                            ...
                            across India. Get expert advice and personalized
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-12">
                            ...
                            >
                                <Image
                                    src="/images/properties/urbanrise-galleria/main.jpg"
                                    alt="Luxury Property"
                                    fill
                        ...
                        <div className="relative py-6">
                            ...
                            >
                                {[...Array(2)].map((_, loop) => (
                                    <div
                                        key={loop}
                                        className="inline-flex items-center space-x-12 md:space-x-16 mr-12 md:mr-16"
                                    >
                                        {[
                                            {
                                                name: "Prestige",
                                            ...
                                            {
                                                name: "Brigade",
                                                logo: "/images/clients/brigade.png",
                                            },
                                            {
                                            ...
                                            {
                                                name: "HDFC",
                                                logo: "/images/clients/hdfc.png",
                                            },
                                            {
                                                name: "ICICI",
                                                logo: "/images/clients/icici.png",
                                            },
                                        ].map((client, i) => (
                                            <motion.div
                                                key={`${i}-${loop}`}
            ...
            >
                ...
                >
                    <motion.div className="space-y-8" variants={itemVariants}>
                        ...
                        >
                            <a href="/properties/india" className="block w-fit">
                                <div className="px-5 sm:px-6 py-2.5 sm:py-3 bg-primary text-white rounded-md hover:bg-primary/90 transition-colors font-medium text-sm sm:text-base w-full text-center group flex items-center justify-center">
                                    View Properties
