                        ...
                        {contactMethods.map((method, index) => (
                            ...
                            >
                                <CardContent className="pt-8 pb-6">
                                    ...
                                    <div className="text-primary font-medium text-sm mb-4 space-y-1">
                                        {method.value}
                                    </div>
                                    <a
            ...
            <section className="md:py-20 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                        {/* Contact Form - Takes 2/5 of the space */}
                        ...
                        {/* Office Information and Map - Takes 3/5 of the space */}
                        <div className="space-y-6 lg:col-span-3">
                            <div>
                                ...
                                <p className="text-gray-600 mb-8">
                                    Visit us at our office or schedule an
