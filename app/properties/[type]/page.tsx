...
// Define the interface locally since we're using default export
...
const getPropertiesByLocation = (properties: Property[], location: LocationType) => {
  return properties.filter(property => property.locationType === location);
};

// Get the count of properties for each tab
const getPropertyCount = (status: string, properties: Property[], location: LocationType) => {
...
export default function TypePage({ params }: TypePageProps) {
  ...
  const [propertyType, setPropertyType] = useState<'all' | 'residential' | 'commercial' | 'vacation' | 'luxury'>('all');
  ...
  const filteredProperties = React.useMemo(() => {
    ...
    return result;
  }, [params.type, activeTab, propertyType]);
  ...
  const handlePropertyTypeChange = (type: 'all' | 'residential' | 'commercial' | 'vacation' | 'luxury') => {
      ...
      <div className="mb-12 max-w-7xl mx-auto">
        {filteredProperties.length > 0 ? (
          <PropertyListingDynamic 
            ...
            filters={{
              type: propertyType as 'residential' | 'commercial' | 'vacation' | 'luxury' | 'all',
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600">
              Calculate your monthly payments and plan your home purchase with confidence
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12">
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <input
                      ...
                      max="90"
                      step="1"
                      value={Math.round((downPayment / propertyPrice) * 100)}
                      onChange={(e) => {
                ...
                <div className="mb-2">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="ml-1 text-xs text-gray-500">p.a.</span>
                    </div>
                  </div>
                  <div className="relative">
                    <input
              ...
              <div className="lg:col-span-5 bg-primary text-white p-6 md:p-8">
                <div className="h-full flex flex-col">
                  <h3 className="text-xl font-bold mb-6">Your Monthly Payment</h3>
                  ...
                  <div className="flex-1 flex flex-col justify-center">
                    ...
                    <div className="space-y-4 mb-8">
                      <div className="flex justify-between items-center pb-2 border-b border-primary-300/30">
                        ...
                        <span className="font-medium">₹{formatCurrency(propertyPrice - downPayment)}</span>
                      </div>
                      <div className="flex justify-between items-center pb-2 border-b border-primary-300/30">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-primary-100">LTV Ratio</span>
          ...
          <div className="mt-8 text-center text-sm text-gray-500">
            <p>Rates and terms are subject to change. This is an estimate only.</p>
          </div>
        </div>
      </section>
      ...
      <section className="pt-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Explore Our Properties on YouTube</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Take a virtual tour of our featured properties and get expert insights from our team
            </p>
          </div>
            ...
            {[
              {
                ...
                title: 'Luxury Villa Tour in Dubai',
                description: 'Experience the epitome of luxury living in this stunning villa.'
              },
              {
                id: 'dQw4w9WgXcQ',
